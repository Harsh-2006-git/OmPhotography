...
export default function Header() {
  ...
  return (
    <>
      ...
      </header>      {/* MOBILE FULL-SCREEN SIDEBAR */}
      <div
        onClick={closeMenu}
        className={`fixed inset-0 z-[60] bg-black/40 backdrop-blur-sm transition-opacity duration-400 md:hidden ${menuOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
          }`}
      />

      <div
        className={`fixed top-0 right-0 bottom-0 z-[70] w-[80vw] max-w-[300px] bg-white flex flex-col transition-transform duration-500 ease-in-out md:hidden ${menuOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
        {/* Sidebar Top Bar */}
        <div className="flex items-center justify-between px-5 pt-8 pb-6 border-b border-[#D9E6E0]">
          <a href="/" onClick={closeMenu} className="flex items-center gap-3 select-none py-1">
            <div className="w-[48px] h-[48px] rounded-full overflow-hidden bg-[#0F5C4D] flex items-center justify-center shrink-0 shadow-[0_4px_12px_rgba(15,92,77,0.08)]">
              <img src="/logo.png" alt="OM Photo Studio" className="w-full h-full object-cover scale-[1.2] rounded-full" />
            </div>
            <div className="flex flex-col select-none justify-center">
              <span className="font-serif text-[22px] font-bold text-[#0F5C4D] tracking-wide uppercase leading-none">Om</span>
              <span className="font-sans text-[8.5px] font-black text-[#18352F] tracking-[0.24em] uppercase mt-[4px] leading-none">PHOTOGRAPHY</span>
            </div>
          </a>
          <button
            onClick={closeMenu}
            className="w-10 h-10 rounded-full border border-[#D9E6E0] flex items-center justify-center text-[#18352F]/70 hover:text-[#0F5C4D] hover:border-[#0F5C4D]/50 transition-all duration-200"
        ...
        <nav className="flex flex-col px-6 pt-6 gap-0 flex-1 overflow-y-auto">
          {[
            ...
            <a
              ...
              href={item.href}
              onClick={closeMenu}
              className="group inline-flex items-center gap-3 py-3.5 border-b border-[#D9E6E0]/60 transition-all duration-200 w-auto"
              style={{ animationDelay: `${i * 60}ms` }}
            >
              <span className="text-[10px] text-[#0F5C4D]/50 font-mono tracking-widest w-5 shrink-0">{item.num}</span>
              <span className="font-serif text-[18px] text-[#18352F]/85 group-hover:text-[#0F5C4D] transition-colors duration-200 leading-none">
                {item.label}
              </span>
        ...
        {/* Bottom Section */}
        <div className="px-6 py-6 border-t border-[#D9E6E0] bg-[#EEF7F2]/30">
          {/* Email row */}
          <div className="flex items-center gap-2 mb-4 text-[#5E6C66] text-[11.5px] font-sans justify-center">
            ...
            <a href="mailto:om.photography.2003@gmail.com" className="hover:text-[#0F5C4D] transition-colors">
          ...
          <div className="flex items-center gap-2.5 mb-5 justify-center">
            ...
            <a 
              ...
              className="w-9 h-9 rounded-full border border-[#0F5C4D]/20 bg-white flex items-center justify-center text-[#0F5C4D]/80 hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:text-white hover:border-transparent transition-all duration-250 shadow-sm"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-[#0F5C4D]/20 bg-white flex items-center justify-center text-[#0F5C4D]/80 hover:bg-[#007AFF] hover:text-white hover:border-transparent transition-all duration-250 shadow-sm"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-[#0F5C4D]/20 bg-white flex items-center justify-center text-[#0F5C4D]/80 hover:bg-[#FF0000] hover:text-white hover:border-transparent transition-all duration-250 shadow-sm"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-[#0F5C4D]/20 bg-white flex items-center justify-center text-[#0F5C4D]/80 hover:bg-[#25D366] hover:text-white hover:border-transparent transition-all duration-250 shadow-sm"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-[#0F5C4D]/20 bg-white flex items-center justify-center text-[#0F5C4D]/80 hover:bg-[#E60023] hover:text-white hover:border-transparent transition-all duration-250 shadow-sm"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
